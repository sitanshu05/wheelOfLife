    ...
    return (
        ...
        <div className="flex flex-col items-center mt-10">
            ...
            <div className="flex flex-col w-11/12 mt-10">
                <h1 className="text-5xl text-rasin_black font-title">
                    Profile
                </h1>
                <div className="mt-6">
                    <InputWithLabel
                ...
                <div className="mt-6">
                    <p className="block text-sm font-medium text-darkest_almond">Reminder in every {user ? user.frequency : 0} months</p>
                    <RatingSlider
                ...
                <div className="flex w-full items-center justify-between mt-6">
                    <a href="" className="text-gray-800">Change Password</a>
                    {!isEditable && <button className="bg-walnut p-3 rounded-lg text-lg text-almond"

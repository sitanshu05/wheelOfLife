...
var Burger = ({
  ...
  const getIsToggled = () => {
    const isToggled2 = toggled !== void 0 ? toggled : toggledInternal;
    return animateOnMount && !mounted ? !isToggled2 : isToggled2;
  };
...
var Tilt = (props) => import_react2.default.createElement(Burger, _extends({}, props, {
  render: (o) => import_react2.default.createElement("div", {
    ...
    onClick: props.disabled ? void 0 : o.handler,
    onKeyUp: props.disabled ? void 0 : (e) => e.key === "Enter" && o.handler(),
    role: "button",
    style: {
      ...o.burgerStyles,

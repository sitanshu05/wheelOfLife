...
const deleteOneWheel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { username } = req;
        ...
        yield wheel_model_1.default.findByIdAndDelete(wheelId);
        yield user_model_1.default.findOneAndUpdate({ username }, { $pull: { wheels: wheelId } });
...
exports.default = deleteOneWheel;
